...
<template>
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Manage your Questions and their permissions
        </p>
      </div>
      <UButton icon="i-heroicons-plus" size="lg" class="w-full sm:w-auto" @click="router.push('/questions/create')">
        Create Questions
      </UButton>
    </div>
    ...
    <UCard v-if="questionsResource.searchable">
      <UInput v-model="searchQuery" icon="i-heroicons-magnifying-glass" placeholder="Search questions..." size="lg" />
    </UCard>
    ...
    <!-- Table -->
    <CrudsCrudTable :config="questionsResource" :items="[...crud.items.value]" :loading="crud.loading.value"
